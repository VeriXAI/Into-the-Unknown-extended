...
def run_experiment_other_abstractions():
    ...
    for n_classes in range(2, total_classes):
        ...
        layer2abstraction = {-2: BoxAbstraction(euclidean_mean_distance)}
        monitor2 = Monitor(layer2abstraction=layer2abstraction)
        layer2abstraction = {-2: MeanBallAbstraction(euclidean_mean_distance)}
        monitor3 = Monitor(layer2abstraction=layer2abstraction)
        layer2abstraction = {-2: OctagonAbstraction(euclidean_mean_distance)}
