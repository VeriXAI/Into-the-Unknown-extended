...
def run_script():
    ...
    monitor_manager = MonitorManager(monitors, clustering_threshold=0.02, n_clusters=60)

    # general run script
    evaluate_combination(seed=seed, data_name=data_name, data_train_model=data_train_model, data_test_model=data_test_model,
