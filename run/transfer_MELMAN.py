...
def run_script():
    ...
    for n_classes in range(2, 3):
        ...
        model_path = "melman_2017_rolling_{}.h5".format(classes_string)
        transfer_model_path = "melman_2017_transferred_{}.h5".format(classes_string)
        if plot_name == "!":
