...
def run_script():
    model_name, data_name, stored_network_name, total_classes, flatten_layer, optimizer = instance_MNIST(transfer=False)
    known_classes = [0, 1]
    all_classes = [0, 1, 2]
    ...
    raw_monitor = Monitor(layer2abstraction=layer2abstraction)
    monitor = DistanceMonitor(raw_monitor, box_distance_parameter)
