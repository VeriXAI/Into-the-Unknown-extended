...
def run_script():
    ...
    model_name = "MNIST"
    model_path = "MNIST_MNIST_10-model.h5"
    n_epochs = 2
    batch_size = 128
    score_fun = F1Score()
    ...
    layer2abstraction6 = {-3: BoxAbstraction(confidence_fun_euclidean, epsilon=epsilon),
                          -2: BoxAbstraction(confidence_fun_euclidean, epsilon=epsilon)}
    ...
    layer2abstraction8 = {-2: PartitionBasedAbstraction(1, partition=uniform_partition(40, 2),
                                                        abstractions=MeanBallAbstraction(confidence_fun_euclidean,
                                                                                         epsilon=epsilon))}
    layer2abstraction9 = {-2: BoxAbstraction(confidence_fun_half_space, epsilon=epsilon)}
    layer2abstraction10 = {-2: ZoneAbstraction(confidence_fun_half_space, epsilon=epsilon),
                          -3: ZoneAbstraction(confidence_fun_half_space, epsilon=epsilon)}
    layer2abstraction11 = {-2: OctagonAbstraction(confidence_fun_half_space, epsilon=epsilon)}
    layer2abstraction12 = {-1: BoxAbstraction(confidence_fun_euclidean, epsilon=epsilon),
                           -2: BoxAbstraction(confidence_fun_euclidean, epsilon=epsilon),
                           -3: BoxAbstraction(confidence_fun_euclidean, epsilon=epsilon),
                           -4: BoxAbstraction(confidence_fun_euclidean, epsilon=epsilon),
                           -5: BoxAbstraction(confidence_fun_euclidean, epsilon=epsilon)}
    layer2abstraction13 = {-2: CheapBooleanAbstraction()}
    layer2abstraction14 = {-2: CheapBooleanAbstraction(),
                           -3: CheapBooleanAbstraction()}
    layer2abstraction15 = {-1: CheapBooleanAbstraction(),
                           -2: CheapBooleanAbstraction(),
                           -3: CheapBooleanAbstraction(),
                           -4: CheapBooleanAbstraction(),
                           -5: CheapBooleanAbstraction()}
    layer2dimensions = {-1: [0, 1], -2: [0, 1], -3: [0, 1], -4: [0, 1], -5: [0, 1]}
    monitors = [
                ...
                # Monitor(layer2abstraction9, score_fun, layer2dimensions),
                # Monitor(layer2abstraction10, score_fun, layer2dimensions),
                # Monitor(layer2abstraction11, score_fun, layer2dimensions),
                # Monitor(layer2abstraction12, score_fun, layer2dimensions),
                # Monitor(layer2abstraction13, score_fun, layer2dimensions),
                # Monitor(layer2abstraction14, score_fun, layer2dimensions),
                # Monitor(layer2abstraction15, score_fun, layer2dimensions),
                ]
    monitor_manager = MonitorManager(monitors, clustering_threshold=0.07, n_clusters=10)
    ...
    evaluate_combination(
        ...
        model_trainer=model_trainer, model_name=model_name, model_path=model_path, n_epochs=n_epochs,
        batch_size=batch_size, monitor_manager=monitor_manager, confidence_thresholds=confidence_thresholds,
        skip_image_plotting=True, alpha=alpha)
